...
### ☁️ 클라우드 저장
- **실시간 동기화**: 게임 진행상황이 실시간으로 클라우드에 저장
- **데이터 보호**: 로컬 저장소 문제 시에도 데이터 안전 보장
...
### 🎮 바로 플레이
[**👉 게임 바로가기 (Vercel)**](https://wave-ver2.vercel.app/) *(업데이트 예정)*
